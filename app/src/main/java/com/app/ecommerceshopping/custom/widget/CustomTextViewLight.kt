...
class CustomTextViewLight  : AppCompatTextView {
    ...
    private fun selectTypeface(context: Context, textStyle: Int): Typeface {
        return when (textStyle) {
            Typeface.BOLD -> Typeface.createFromAsset(context.assets, "Quicksand-Light.ttf")
            Typeface.NORMAL -> Typeface.createFromAsset(context.assets, "Quicksand-Light.ttf")// regular
            else -> Typeface.createFromAsset(context.assets, "Quicksand-Light.ttf")// regular
        }
    }
