...
class CustomTextViewMedium  : AppCompatTextView {
    ...
    private fun selectTypeface(context: Context, textStyle: Int): Typeface {
        return when (textStyle) {
            Typeface.BOLD -> Typeface.createFromAsset(context.assets, "Quicksand-Medium.ttf")
            Typeface.NORMAL -> Typeface.createFromAsset(context.assets, "Quicksand-Medium.ttf")// regular
            else -> Typeface.createFromAsset(context.assets, "Quicksand-Medium.ttf")// regular
        }
    }
